           ...
           <!--  <div class="form-group" style="margin-top: 10px">
            ...
            <div class="form-group" style="margin-top: 10px">
              <div class="form-row">
                <div class="col-md-12">
                  <div class="form-label-group">
                    <input type="text" id="referredBy" class="form-control" placeholder="Referred By" required="required" autofocus="autofocus" name="referredBy">
            ...
            <div class="form-group" style="margin-top: 10px">
              <div class="form-row">
                <div class="col-md-12">
                  <label>Accompanied By/ Informant:</label>
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-4">
                  <div class="form-label-group">
                    <input type="text" id="informantName" class="form-control" placeholder="Name" required="required" autofocus="autofocus" name="informantName">
                    <label for="informantName">Name</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-label-group">
                    <input type="text" id="informantAddress" class="form-control" placeholder="Address" required="required" name="informantAddress">
                    <label for="informantAddress">Address</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-label-group">
                    <input type="text" id="informantContactNum" class="form-control" placeholder="Contact No." required="required" name="informantContactNum">
                    <label for="informantContactNum">Contact No.</label>
                  </div>
                </div>
              </div>
            </div>
