...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: 'List of Current Patient {0}',                                                        // text when all options are visible / false for no info text
      ...
      infoTextEmpty: 'List of PAtient to Attend',                                                        // when there are no options present in the list
